...
const REDES = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/cesmvc.ufpr/',
    svg: (
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@cesmvc?si=lqaMYOODkDcuuqA8',
    svg: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61590548670827&mibextid=ZbWKwL',
    svg: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/curso-de-especializa%C3%A7%C3%A3o-em-medicina-veterin%C3%A1ria-do-coletivo-ufpr/posts/',
    svg: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
